...
##Adjust base plotting parameters for 2x2 layout
par(mfrow=c(2,2))

##Make plot 1
with(df, plot(x= Datetime, y = Global_active_power, type = "l", xlab = "", ylab = "Global Active Power"))

##Make plot 2
with(df, plot(x= Datetime, y = Voltage, type = "l", xlab = "datetime", ylab = "Voltage"))
...
##Make plot 4
with(df, plot(x= Datetime, y = Global_reactive_power, type = "l", xlab = "datetime"))
